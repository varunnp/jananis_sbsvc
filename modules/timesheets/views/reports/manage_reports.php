...
<?php if(has_permission('report_management', '', 'view') || is_admin()){ ?>
  <div class="row sorting_table hide">
    <div class="table-fillter col-md-3">
 ...
 <div class="table-fillter col-md-3">
      <div class="form-group">
       <label for="annual_leave">Project</label>
       <select name="project" class="selectpicker" data-live-search="true"  data-width="100%" data-none-selected-text="<?php echo _l('invoice_status_report_all'); ?>">
           <option value=""></option>
        <?php foreach($projects as $project){ ?>
         <option value="<?php echo html_entity_decode($project['id']); ?>"><?php echo html_entity_decode($project['name']) ?></option>
       <?php } ?>
     </select>
   </div>
 </div>
