...
$v_type = $this->ci->input->post('v_type');
$where_vtype = '';
if(isset($v_type)){
    $where_vtype .= " AND tblpur_estimates.v_type = 'vendor_price' ";
}else{
    $where_vtype .= " AND tblpur_estimates.v_type = '' ";
}
array_push($where, $where_vtype);
