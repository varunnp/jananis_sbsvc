...
<div id="wrapper">
   <div class="content">
    <?php echo form_open($this->uri->uri_string(),array('id'=>'add_edit_pur_request-form','class'=>'_transaction_form')); ?>
      <div class="row">
          <input type="hidden" name="req_type" value="price_list">
         <div class="col-md-12">
            <div class="panel_s">
               <div class="panel-body">
                  <h4 class="customer-profile-group-heading"><?php if(isset($pur_request)){ echo html_entity_decode($pur_request->pur_rq_code); }else{ echo 'Add new price list' ; } ?></h4>
                  <?php 
                ...
                <div class="row accounting-template">
                  ...
                  <div class="row ">
                    <div class="col-md-12">
                      ...
                      echo render_input('pur_rq_code','Price List Code',$pur_rq_code ,'text',array('readonly' => '')); ?>
                    </div>
                    <div class="col-md-6">
                      <?php $pur_rq_name = ( isset($pur_request) ? $pur_request->pur_rq_name : '');
                      echo render_input('pur_rq_name','Price List Name', $pur_rq_name); ?>
                    </div>
