      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
            <div class="row">
                     <div class="col-md-12">
                      <h4 class="no-margin font-bold"><i class="fa fa-shopping-basket" aria-hidden="true"></i> Price List</h4>
                      <hr />
                     </div>
                    </div>
                    <div class="row"> 
                    <input type="hidden" name="group_job" value="<?php echo $group; ?>">        
                        <div class="_buttons col-md-2">
                            ...
                            <a href="<?php echo admin_url('purchase/price_list_request'); ?>"class="btn btn-info pull-left mright10 display-block">
