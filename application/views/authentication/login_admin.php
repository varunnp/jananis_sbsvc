...
<style>
.coverpage {
    background: url(../assets/images/avip1.png) no-repeat center center fixed;
    background-size: cover;
}
</style>

<body class="tw-bg-neutral-100 login_admin coverpage">

    <div class="tw-max-w-md tw-mx-auto tw-pt-24 authentication-form-wrapper tw-relative tw-z-20" style="width:100%;float:right;">
