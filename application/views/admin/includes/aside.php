        ...
        <li class="menu-item-<?php echo e($item['slug']); ?>"
            ...
            <ul class="nav nav-second-level collapse" aria-expanded="false">
               ...
               <?=isset($submenu['badge']['type']) && $submenu['badge']['type'] != '' ? "bg-{$submenu['badge']['type']}" : 'bg-info' ?>" <?=(isset($submenu['badge']['type']) && $submenu['badge']['type'] == '') ||
                ...
                ?>
                    <li class="sub-menu-item-purchase-joborder"><a href="<?php echo admin_url('advances'); ?>">
                        <i class="fa fa-usd menu-icon"></i>
                        <span class="sub-menu-text">
                            <?php echo 'Staff Advance'; ?>
                        </span>
                    </a>
                ...
                ?>
                    <li class="sub-menu-item-purchase-joborder"><a href="<?php echo admin_url('purchase/purchase_request?group=price_list'); ?>">
                        <i class="fa fa-inr menu-icon"></i>
                        <span class="sub-menu-text">
                            <?php echo 'Price List'; ?>
                        </span>
                    </a>
                ...
                if($item['slug'] == 'purchase'){
                ?>
                    <li class="sub-menu-item-purchase-joborder"><a href="<?php echo admin_url('purchase/quotations?group=vendor_price'); ?>">
                        <i class="fa fa-inr menu-icon"></i>
                        <span class="sub-menu-text">
                            <?php echo 'Vendor Price'; ?>
                        </span>
                    </a>
