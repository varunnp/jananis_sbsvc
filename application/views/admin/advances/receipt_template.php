...
<div id="wrapper">
    <div class="content">
        <div class="row">
            <?php echo form_open(admin_url('advances/record_payment'), ['id' => 'record_receipt']); ?>
    ...
    <div class="panel_s">
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="f_client_id">
                        <div class="form-group select-placeholder">
                            ...
                            <select id="clientid" name="clientid"  data-width="100%" data-live-search="true" class="ajax-search" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                <?php 
                    ...
                    $amount       = 0;
                    $totalAllowed = 0;
                    echo render_input('beni_name', 'Benificiary Name', '', 'text');
                     ?>
                ...
                <div class="col-md-6">
                    <?php 
                    echo render_input('amount', 'Advance Amount', $amount, 'number');
                    echo render_date_input('date', 'Advance Date', _d(date('Y-m-d')));
                    ?>
