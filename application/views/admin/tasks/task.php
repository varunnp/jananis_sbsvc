                  ...
                  ?>
                     ...
                     ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group" >
                                    <label  class="control-label"> Client Cost</label>
                                    <input type="text" id="client_cost" name="client_cost" class="form-control" value="<?php if (isset($task) && $task->client_cost != '') {
                            echo $task->client_cost; } ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" >
                                    <label class="control-label">  Unit Rate</label>
                                    <input type="text" id="unit_rate" name="unit_rate" class="form-control" value="<?php if (isset($task) && $task->unit_rate != '') {
                            echo $task->unit_rate; } ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" >
                                    ...
                                    <input type="text" id="total_qty" name="total_qty" class="form-control" value="<?php if (isset($task) && $task->total_qty != '') {
                            echo $task->total_qty; } ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"  >
                                    ...
                                    <input type="text" id="unit_qty" name="unit_qty" class="form-control" value="<?php if (isset($task) && $task->unit_qty != '') {
                            echo $task->unit_qty; } ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group" >
                                    <label class="control-label">Quantity Measures</label>
                                    <div id="qty_measures">
                                        <select name="qty_measures" id="qty_measures" class="selectpicker"
                                        data-width="100%"
                                        data-none-selected-text="">
                                            <option <?php if (isset($task) && $task->qty_measures == 'Nos') {
                            echo 'selected'; } ?>  value="Nos">Nos</option>
                                            <option <?php if (isset($task) && $task->qty_measures == 'Unit') {
                            echo 'selected'; } ?>  value="Unit">Unit</option>
                                            <option <?php if (isset($task) && $task->qty_measures == 'Kg') {
                            echo 'selected'; } ?>  value="Kg">Kg</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group"  >
                                    ...
                                    <input type="text" id="allocated_budget" name="allocated_budget" class="form-control" value="<?php if (isset($task) && $task->allocated_budget != '') {
                            echo $task->allocated_budget; } ?>">
                                </div>
                            </div>
                        </div>
