...
*
*/
define('APP_BASE_URL', 'https://sb.svc.avip-cs.com/');
...
*/
define('APP_ENC_KEY', '5dabff1116beb769ab0c3b8416dec9c8');
 ...
 */
define('APP_DB_USERNAME', 'c2321174c_sb_svc_admin');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'France@123!@#');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'c2321174c_sb_svc');
